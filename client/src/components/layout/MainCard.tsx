...
export default function MainCard({ children, className }: MainCardProps) {
  ...
  return (
    <main className={cn(
      "relative rounded-3xl bg-[color:var(--card)] shadow-[0_12px_40px_rgba(0,0,0,0.08)] border border-black/5 overflow-hidden h-full z-0 dark:border-white/10 flex flex-col",
      className

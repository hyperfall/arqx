...
const mockToolSpecs: Record<string, FastlaneToolSpec> = {
  ...
  "audio-format-converter": {
    ...
    inputs: {
      accept: ["audio/mp3", "audio/wav", "audio/flac", "audio/aac", "audio/ogg", "audio/m4a"],
      maxSize: 50 * 1024 * 1024,
      multiple: true,
    },
  },
  ...
  "pdf-text-extractor": {
    ...
    settings: {
      ...
      pageRange: {
        ...
        label: "Page Range",
        default: "all",
        options: ["all", "first", "last", "custom"],
      },
      outputFormat: {
        type: "select",
        label: "Output Format",
        default: "txt",
        options: ["txt", "rtf", "html", "markdown"],
      },
      language: {
        type: "select",
        label: "OCR Language",
  ...
  "advanced-text-formatter": {
    ...
    settings: {
      caseTransform: {
        ...
        default: "none",
        options: ["none", "uppercase", "lowercase", "title", "sentence"],
      },
      lineEndings: {
        type: "select",
        label: "Line Endings",
    ...
    inputs: {
      accept: ["text/plain", "text/csv", "text/rtf"],
      maxSize: 5 * 1024 * 1024,
      multiple: true,
    },
  },
